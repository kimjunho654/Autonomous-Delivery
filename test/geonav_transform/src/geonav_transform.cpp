...
void GeonavTransform::run()
{
  ...
  nh_priv.param<std::string>("base_link_frame_id", base_link_frame_id_, "base_footprint");
  ...
  ros::Subscriber geo_odom_sub = nh.subscribe("/odom", 1,
