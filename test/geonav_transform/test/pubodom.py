...
def pose_callback(msg):
    ...
    new_msg.pose.pose.orientation.z = 0.069
...
def talker():
    ...
    while not rospy.is_shutdown():
        ...
        omsg.pose.pose.orientation.x = 0 #q[0]
        omsg.pose.pose.orientation.y = 0 #q[1]
        ...
        omsg.twist.twist.linear.x= 0
        omsg.twist.twist.linear.y= 0
        omsg.twist.twist.linear.z= 0
        omsg.twist.twist.angular.x= 0
        omsg.twist.twist.angular.y= 0
        omsg.twist.twist.angular.z= 0
